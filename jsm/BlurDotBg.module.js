...
var X = function(t, e) {
  ...
  , Y = function(t) {
    ...
    n(r, [{
        ...
        key: "set",
        value: function(t, e, i, r) {
            return t.length ? this.copy(t) : (V(this._target, t, e, i, r),
            this.onChange(),
            this)
        }
    }, {
        ...
        value: function(t, e) {
            return function(t, e, i, r) {
                var n, s, a, h, o, u = e[0], l = e[1], c = e[2], f = e[3], d = i[0], g = i[1], v = i[2], p = i[3];
                (s = u * d + l * g + c * v + f * p) < 0 && (s = -s,
                d = -d,
                g = -g,
                v = -v,
                p = -p),
...
function Z(t) {
    var e = t[0]
      ...
      , v = t[14]
      , p = t[15];
    return (e * a - i * s) * (c * p - f * v) - (e * h - r * s) * (l * p - f * g) + (e * o - n * s) * (l * v - c * g) + (i * h - r * a) * (u * p - f * d) - (i * o - n * a) * (u * v - c * d) + (r * o - n * h) * (u * g - l * d)
}
function Q(t, e, i) {
    var r = e[0]
      , n = e[1]
...
function(t, e) {
    ...
    t[0] = .25 * p,
    t[1] = (h + u) / p,
    t[2] = (f + o) / p) : l > g ? (p = 2 * Math.sqrt(1 + l - a - g),
    t[3] = (f - o) / p,
    t[0] = (h + u) / p,
    t[1] = .25 * p,
    t[2] = (c + d) / p) : (p = 2 * Math.sqrt(1 + g - a - l),
    t[3] = (h - u) / p,
    t[0] = (f + o) / p,
    t[1] = (c + d) / p,
    t[2] = .25 * p),
...
var it = function(t) {
    ...
    n(r, [{
        ...
        value: function(t, e, i, r, n, s, a, h, o, u, l, c, f, d, g, v) {
            return t.length ? this.copy(t) : (function(t, e, i, r, n, s, a, h, o, u, l, c, f, d, g, v, p) {
                t[0] = e,
                t[1] = i,
                t[2] = r,
                t[3] = n,
        ...
        value: function(t) {
            return function(t, e, i) {
                var r, n, s, a, h, o, u, l, c, f, d, g, v = i[0], p = i[1], m = i[2];
        ...
        value: function(t, e) {
            return function(t, e, i, r) {
                var n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, M, w, k, A, T, R = r[0], F = r[1], S = r[2], C = Math.hypot(R, F, S);
        ...
        value: function(t, e) {
            var i, r, n;
            return t.length ? e ? Q(this, t, e) : Q(this, this, t) : (r = this,
            n = t,
            (i = this)[0] = r[0] * n,
            i[1] = r[1] * n,
            i[2] = r[2] * n,
        ...
        key: "inverse",
        value: function() {
            var t, e, i, r, n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, M, w, k, A, T, R, F, S;
            return t = this,
            ...
            p = e[14],
            m = e[15],
            (S = (y = i * h - r * a) * (F = f * m - d * p) - (_ = i * o - n * a) * (R = c * m - d * v) + (b = i * u - s * a) * (T = c * p - f * v) + (x = r * o - n * h) * (A = l * m - d * g) - (E = r * u - s * h) * (k = l * p - f * g) + (M = n * u - s * o) * (w = l * v - c * g)) && (S = 1 / S,
            t[0] = (h * F - o * R + u * T) * S,
            t[1] = (n * R - r * F - s * T) * S,
            t[2] = (v * M - p * E + m * x) * S,
            t[3] = (f * E - c * M - d * x) * S,
        ...
        key: "compose",
        value: function(t, e, i) {
            var r, n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, M, w, k;
            return n = e,
            s = i,
            a = this,
            h = (r = t)[0],
        ...
        value: function(t, e, i) {
            return function(t, e, i, r) {
                ...
                var g = o * f - u * c
                  , v = u * l - h * f
                  , p = h * c - o * l;
                0 == (d = g * g + v * v + p * p) && (u ? h += 1e-6 : o ? u += 1e-6 : o += 1e-6,
                d = (g = o * f - u * c) * g + (v = u * l - h * f) * v + (p = h * c - o * l) * p),
                g *= d = 1 / Math.sqrt(d),
                v *= d,
                p *= d,
                t[0] = g,
...
var rt = new it
  ...
  , ut = function(t) {
    function r(t) {
        var n, s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, a = s.near, h = void 0 === a ? .1 : a, o = s.far, u = void 0 === o ? 100 : o, l = s.fov, c = void 0 === l ? 45 : l, f = s.aspect, d = void 0 === f ? 1 : f, g = s.left, v = s.right, p = s.bottom, m = s.top, y = s.zoom, _ = void 0 === y ? 1 : y;
        return i(this, r),
        n = e(this, r),
        Object.assign(n, {
            near: h,
    ...
    n(r, [{
        ...
        key: "unproject",
        value: function(t) {
            return t.applyMatrix4(at.inverse(this.projectionMatrix)),
...
var ct = function(t) {
    function r() {
        var t, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1, s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0, h = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, l = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0, c = arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : 0, f = arguments.length > 7 && void 0 !== arguments[7] ? arguments[7] : 0, d = arguments.length > 8 && void 0 !== arguments[8] ? arguments[8] : 1;
        return i(this, r),
        u(t = e(this, r, [n, s, a, h, o, l, c, f, d]), t)
    }
    return h(r, v(Array)),
    n(r, [{
        key: "set",
        ...
        value: function() {
            ...
            u = e[7],
            l = e[8],
            (g = i * (c = l * a - h * u) + r * (f = -l * s + h * o) + n * (d = u * s - a * o)) && (g = 1 / g,
            t[0] = c * g,
            t[1] = (-l * r + n * u) * g,
            t[2] = (h * r - n * a) * g,
            t[3] = f * g,
        ...
        key: "getNormalMatrix",
        value: function(t) {
            var e, i, r, n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, M, w, k, A, T, R, F, S, C;
            return e = this,
            r = (i = t)[0],
            n = i[1],
            s = i[2],
            ...
            m = i[14],
            y = i[15],
            (C = (_ = r * o - n * h) * (S = d * y - g * m) - (b = r * u - s * h) * (F = f * y - g * p) + (x = r * l - a * h) * (R = f * m - d * p) + (E = n * u - s * o) * (T = c * y - g * v) - (M = n * l - a * o) * (A = c * m - d * v) + (w = s * l - a * u) * (k = c * p - f * v)) && (C = 1 / C,
            e[0] = (o * S - u * F + l * R) * C,
            e[1] = (u * T - h * S - l * A) * C,
            e[2] = (h * F - o * T + l * k) * C,
            e[3] = (s * F - n * S - a * R) * C,
  ...
  , dt = function(t) {
    function r(t) {
        var n, s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, a = s.geometry, h = s.program, o = s.mode, u = void 0 === o ? t.TRIANGLES : o, l = s.frustumCulled, c = void 0 === l || l, f = s.renderOrder, d = void 0 === f ? 0 : f;
        return i(this, r),
        n = e(this, r),
        t.canvas,
        n.gl = t,
        ...
        value: function() {
            ...
            e) {
                ...
                this.image) {
                    ...
                    this.generateMipmaps && (this.gl.renderer.isWebgl2 || vt(this.image.width) && vt(this.image.height) ? this.gl.generateMipmap(this.target) : (this.generateMipmaps = !1,
  ...
  , yt = function() {
    return n((function t(e) {
        ...
        for (var B = [], D = 0; D < c; D++)
            ...
            this.gl.framebufferTexture2D(this.target, this.gl.COLOR_ATTACHMENT0 + D, this.gl.TEXTURE_2D, this.textures[D].texture, 0),
            B.push(this.gl.COLOR_ATTACHMENT0 + D);
        B.length > 1 && this.gl.renderer.drawBuffers(B),
        this.texture = this.textures[0],
        m && (this.gl.renderer.isWebgl2 || this.gl.renderer.getExtension("WEBGL_depth_texture")) ? (this.depthTexture = new mt(e,{
            width: s,
            height: h,
        ...
        this.gl.framebufferTexture2D(this.target, this.gl.DEPTH_ATTACHMENT, this.gl.TEXTURE_2D, this.depthTexture.texture, 0)) : (d && !v && (this.depthBuffer = this.gl.createRenderbuffer(),
        this.gl.bindRenderbuffer(this.gl.RENDERBUFFER, this.depthBuffer),
        this.gl.renderbufferStorage(this.gl.RENDERBUFFER, this.gl.DEPTH_COMPONENT16, s, h),
        this.gl.framebufferRenderbuffer(this.target, this.gl.DEPTH_ATTACHMENT, this.gl.RENDERBUFFER, this.depthBuffer)),
        v && !d && (this.stencilBuffer = this.gl.createRenderbuffer(),
        this.gl.bindRenderbuffer(this.gl.RENDERBUFFER, this.stencilBuffer),
        this.gl.renderbufferStorage(this.gl.RENDERBUFFER, this.gl.STENCIL_INDEX8, s, h),
        this.gl.framebufferRenderbuffer(this.target, this.gl.STENCIL_ATTACHMENT, this.gl.RENDERBUFFER, this.stencilBuffer)),
        d && v && (this.depthStencilBuffer = this.gl.createRenderbuffer(),
...
function Et(t) {
    return void 0 === t ? [0, 0, 0] : 3 === arguments.length ? arguments : isNaN(t) ? "#" === t[0] ? bt(t) : _t[t.toLowerCase()] ? bt(_t[t.toLowerCase()]) : [0, 0, 0] : xt(t)
}
var Mt = Object.freeze({
  ...
  , wt = function(t) {
    function r(t) {
        var n;
        return i(this, r),
        Array.isArray(t) ? u(n, n = e(this, r, c(t))) : u(n, n = e(this, r, c(Et.apply(Mt, arguments))))
    }
    return h(r, v(Array)),
    n(r, [{
        key: "r",
        ...
        key: "set",
        value: function(t) {
            return Array.isArray(t) ? this.copy(t) : this.copy(Et.apply(Mt, arguments))
        }
    }, {
        key: "copy",
        value: function(t) {
...
var St = function(t) {
    ...
    n(r, [{
        ...
        key: "add",
        value: function(t, e) {
            return e ? kt(this, t, e) : kt(this, this, t),
            this
        }
    }, {
        key: "sub",
  ...
  , Ct = function(t) {
    ...
    n(r, null, [{
        key: "buildPlane",
        value: function(t, e, i, r, n, s, a, h, o) {
            for (var u = arguments.length > 9 && void 0 !== arguments[9] ? arguments[9] : 0, l = arguments.length > 10 && void 0 !== arguments[10] ? arguments[10] : 1, c = arguments.length > 11 && void 0 !== arguments[11] ? arguments[11] : 2, f = arguments.length > 12 && void 0 !== arguments[12] ? arguments[12] : 1, d = arguments.length > 13 && void 0 !== arguments[13] ? arguments[13] : -1, g = arguments.length > 14 && void 0 !== arguments[14] ? arguments[14] : 0, v = arguments.length > 15 && void 0 !== arguments[15] ? arguments[15] : 0, p = g, m = n / h, y = s / o, _ = 0; _ <= o; _++)
...
var Pt = function() {
  ...
  , Ot = function(t) {
    function r() {
        ...
        return i(this, r),
        (t = e(this, r, [n, 4])).options = t.params.options || {},
        t.ratio,
        t.rect,
        t.move = [0, 0, 0, 0],
        t.start(),
    ...
    n(r, [{
        ...
        value: function() {
            ...
            this.rect = new St(this.ratio / 2,.5)
        }
    }, {
        key: "_initRtt",
        value: function() {
        ...
        key: "_resetSeed",
        value: function() {
            this.rttProgram.uniforms.u_p0_s.value = this.rng() + .8,
            this.rttProgram.uniforms.u_p1_s.value = this.rng() + .8,
            this.rttProgram.uniforms.u_p2_s.value = this.rng() + .8,
            this.rttProgram.uniforms.u_p3_s.value = this.rng() + .8,
        ...
        key: "_resetColors",
        value: function() {
            this.rttProgram.uniforms.u_color_0.value = new wt(this.palette[0]),
            this.rttProgram.uniforms.u_color_1.value = new wt(this.palette[1]),
            this.rttProgram.uniforms.u_color_2.value = new wt(this.palette[2]),
            this.rttProgram.uniforms.u_color_3.value = new wt(this.palette[3])
        }
    }, {
        key: "_animate",
        value: function() {
