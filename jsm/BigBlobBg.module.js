    ...
    return n((function t(e) {
        ...
        value: function() {
            ...
            this.uniformLocations.forEach((function(e, i) {
                ...
                if (!s)
                    return I("Active uniform ".concat(i.name, " has not been supplied"));
                if (s && void 0 === s.value)
                    return I("".concat(i.name, " uniform is missing a value parameter"));
                if (s.value.texture)
                    return r += 1,
                    s.value.update(r),
                    N(t.gl, i.type, e, r);
...
var H = G
  ...
  , $ = function(t) {
    ...
    n(r, [{
        ...
        key: "multiply",
        value: function(t, e) {
            return e ? Y(this._target, t, e) : Y(this._target, this._target, t),
            this.onChange(),
            this
        }
    }, {
...
var at = function(t) {
    ...
    n(r, [{
        ...
        value: function(t, e) {
            return function(t, e, i, r) {
                var n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, w, M, A, k, T, R = r[0], F = r[1], S = r[2], C = Math.hypot(R, F, S);
        ...
        key: "inverse",
        value: function() {
            var t, e, i, r, n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, w, M, A, k, T, R, F, S;
            return t = this,
            ...
            p = e[14],
            m = e[15],
            (S = (y = i * h - r * a) * (F = f * m - d * p) - (_ = i * o - n * a) * (R = c * m - d * v) + (b = i * u - s * a) * (T = c * p - f * v) + (x = r * o - n * h) * (k = l * m - d * g) - (E = r * u - s * h) * (A = l * p - f * g) + (w = n * u - s * o) * (M = l * v - c * g)) && (S = 1 / S,
            t[0] = (h * F - o * R + u * T) * S,
            t[1] = (n * R - r * F - s * T) * S,
            t[2] = (v * w - p * E + m * x) * S,
            t[3] = (f * E - c * w - d * x) * S,
        ...
        key: "compose",
        value: function(t, e, i) {
            var r, n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, w, M, A;
            return n = e,
            s = i,
            a = this,
            h = (r = t)[0],
...
var vt = function(t) {
    ...
    n(r, [{
        ...
        key: "getNormalMatrix",
        value: function(t) {
            var e, i, r, n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, w, M, A, k, T, R, F, S, C;
            return e = this,
            r = (i = t)[0],
            n = i[1],
            s = i[2],
            ...
            m = i[14],
            y = i[15],
            (C = (_ = r * o - n * h) * (S = d * y - g * m) - (b = r * u - s * h) * (F = f * y - g * p) + (x = r * l - a * h) * (R = f * m - d * p) + (E = n * u - s * o) * (T = c * y - g * v) - (w = n * l - a * o) * (k = c * m - d * v) + (M = s * l - a * u) * (A = c * p - f * v)) && (C = 1 / C,
            e[0] = (o * S - u * F + l * R) * C,
            e[1] = (u * T - h * S - l * k) * C,
            e[2] = (h * F - o * T + l * A) * C,
            e[3] = (s * F - n * S - a * R) * C,
  ...
  , Lt = function(t) {
    function r(t) {
        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
          ...
          , o = void 0 === h ? 16 : h
          , u = n.heightSegments
          , l = void 0 === u ? Math.ceil(.5 * o) : u
          , c = n.phiStart
          , f = void 0 === c ? 0 : c
          , d = n.phiLength
          , g = void 0 === d ? 2 * Math.PI : d
          , v = n.thetaStart
          , p = void 0 === v ? 0 : v
          , m = n.thetaLength
          , y = void 0 === m ? Math.PI : m
          , _ = n.attributes
          , b = void 0 === _ ? {} : _;
        i(this, r);
        for (var x = o, E = l, w = f, M = g, A = p, k = y, T = (x + 1) * (E + 1), F = x * E * 6, S = new Float32Array(3 * T), C = new Float32Array(3 * T), P = new Float32Array(2 * T), D = T > 65536 ? new Uint32Array(F) : new Uint16Array(F), O = 0, B = 0, U = 0, N = A + k, L = [], I = new R, z = 0; z <= E; z++) {
            for (var j = [], X = z / E, G = 0; G <= x; G++,
            O++) {
                var q = G / x
                  , V = -a * Math.cos(w + q * M) * Math.sin(A + X * k)
                  , W = a * Math.cos(A + X * k)
                  , Y = a * Math.sin(w + q * M) * Math.sin(A + X * k);
                S[3 * O] = V,
                S[3 * O + 1] = W,
                S[3 * O + 2] = Y,
                I.set(V, W, Y).normalize(),
                C[3 * O] = I.x,
                C[3 * O + 1] = I.y,
                C[3 * O + 2] = I.z,
                P[2 * O] = q,
...
function It(t, e, i, r) {
    ...
    this.surround = function(t) {
        ...
        for (var i = 0, r = this.posAttribute.count; i < r; i++) {
            if ((e = new R(this.posAttribute.getX(i),this.posAttribute.getY(i),this.posAttribute.getZ(i)).distance(this.anchor)) < this.effectradius) {
                var n = e / this.effectradius
                  , s = 1 / (.25 * Math.sqrt(6.28)) * Math.exp(-n * n / .125) / 1.6;
                this.map.set(i, s)
            }
        }
    }
...
var zt = function(t) {
    ...
    n(r, [{
        ...
        value: function() {
            this.blobs = [];
            for (var t = 0; t < 4; t++) {
                var e = this.rng() * Math.PI * 2
                  , i = this.radius * Math.cos(e)
                  , r = this.radius * Math.sin(e)
                  , n = this.radius * (1 + this.rng() / 4) * Math.cos(e)
                  , s = this.radius * (1 + this.rng() / 4) * Math.sin(e);
                this.blobs.push({
                    anchorX: i,
                    anchorY: r,
                    moveToX: n,
        ...
        value: function() {
            ...
            this.rttPlaneGeo = new Ut(this.gl,{}),
            this.rttProgram = new U(this.gl,{
        ...
        key: "_makeMaterial",
        value: function() {
            this._planeShader = new U(this.gl,{
                vertex: "\n\t\t\t\tattribute vec2 uv;\n\t\t\t\tattribute vec3 position;\n\t\t\t\tuniform mat4 modelViewMatrix;\n\t\t\t\tuniform mat4 projectionMatrix;\n\t\t\t\tvarying vec2 vUv;\n\t\t\t\tvoid main() {\n\t\t\t\t\tvUv = uv;\n\t\t\t\t\tgl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);\n\t\t\t\t}\n\t\t\t",
            ...
            this._blobShader = new U(this.gl,{
        ...
        value: function() {
            ...
            for (var e = 0; e < 4; e++) {
                var i = this.blobs[e]
                  , r = new It(i.anchorX,i.anchorY,0,this.radius);
                r.surround(this.blob_geo),
                r.moveTo(i.moveToX, i.moveToY, 0)
            }
            this.blob = new mt(this.gl,{
        ...
        key: "_resetColors",
        value: function() {
            this._planeShader.uniforms.u_color_0.value = new Rt(this.palette[0]),
            ...
            this._blobShader.uniforms.uLightDiffuse.value = new Rt(this.palette[0])
        }
    }, {
        key: "_animate",
        value: function() {
