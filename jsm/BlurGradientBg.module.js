...
var it = function(t) {
    ...
    n(r, [{
        ...
        value: function(t, e) {
            return function(t, e, i, r) {
                var n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, w, M, k, A, T, R = r[0], F = r[1], S = r[2], C = Math.hypot(R, F, S);
        ...
        key: "inverse",
        value: function() {
            var t, e, i, r, n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, w, M, k, A, T, R, F, S;
            return t = this,
            ...
            p = e[14],
            m = e[15],
            (S = (y = i * h - r * a) * (F = f * m - d * p) - (_ = i * o - n * a) * (R = c * m - d * v) + (b = i * u - s * a) * (T = c * p - f * v) + (x = r * o - n * h) * (A = l * m - d * g) - (E = r * u - s * h) * (k = l * p - f * g) + (w = n * u - s * o) * (M = l * v - c * g)) && (S = 1 / S,
            t[0] = (h * F - o * R + u * T) * S,
            t[1] = (n * R - r * F - s * T) * S,
            t[2] = (v * w - p * E + m * x) * S,
            t[3] = (f * E - c * w - d * x) * S,
        ...
        key: "compose",
        value: function(t, e, i) {
            var r, n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, w, M, k;
            return n = e,
            s = i,
            a = this,
            h = (r = t)[0],
...
var ct = function(t) {
    ...
    n(r, [{
        ...
        key: "getNormalMatrix",
        value: function(t) {
            var e, i, r, n, s, a, h, o, u, l, c, f, d, g, v, p, m, y, _, b, x, E, w, M, k, A, T, R, F, S, C;
            return e = this,
            r = (i = t)[0],
            n = i[1],
            s = i[2],
            ...
            m = i[14],
            y = i[15],
            (C = (_ = r * o - n * h) * (S = d * y - g * m) - (b = r * u - s * h) * (F = f * y - g * p) + (x = r * l - a * h) * (R = f * m - d * p) + (E = n * u - s * o) * (T = c * y - g * v) - (w = n * l - a * o) * (A = c * m - d * v) + (M = s * l - a * u) * (k = c * p - f * v)) && (C = 1 / C,
            e[0] = (o * S - u * F + l * R) * C,
            e[1] = (u * T - h * S - l * A) * C,
            e[2] = (h * F - o * T + l * k) * C,
            e[3] = (s * F - n * S - a * R) * C,
...
var wt = Object.freeze({
  ...
  , Mt = function(t) {
    function r(t) {
        var n;
        return i(this, r),
        Array.isArray(t) ? u(n, n = e(this, r, c(t))) : u(n, n = e(this, r, c(Et.apply(wt, arguments))))
    }
    return h(r, v(Array)),
    n(r, [{
        key: "r",
        ...
        key: "set",
        value: function(t) {
            return Array.isArray(t) ? this.copy(t) : this.copy(Et.apply(wt, arguments))
        }
    }, {
        key: "copy",
        value: function(t) {
...
var Pt = function() {
  ...
  , Ot = function(t) {
    ...
    n(r, [{
        ...
        value: function() {
            ...
            this.rttProgram = new D(this.gl,{
                ...
                uniforms: {
                    ...
                    u_color_1: {
                        value: new Mt(this.palette[1])
                    },
                    u_color_2: {
                        value: new Mt(this.palette[2])
                    },
                    u_color_3: {
                        value: new Mt(this.palette[3])
                    },
                    u_scale: {
                        value: 1.3
                    },
        ...
        key: "_resetColors",
        value: function() {
            this.rttProgram.uniforms.u_color_0.value = new Mt(this.palette[0]),
            this.rttProgram.uniforms.u_color_1.value = new Mt(this.palette[1]),
            this.rttProgram.uniforms.u_color_2.value = new Mt(this.palette[2]),
            this.rttProgram.uniforms.u_color_3.value = new Mt(this.palette[3])
        }
    }, {
        key: "_animate",
        value: function() {
            this.rttProgram.uniforms.u_time.value = 10 * Math.sin(this.frame / 200)
        }
    }, {
        key: "update",
        value: function(t, e) {
